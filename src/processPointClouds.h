...
struct KdTree_eculdian{
Node* root;
 KdTree_eculdian():root(NULL)
 {}
...
public:
    ...
    std::vector<typename pcl::PointCloud<PointT>::Ptr> Clustering(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize);
     ...
     std::vector<typename pcl::PointCloud<PointT>::Ptr> EculdianClustering(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize);
    
    std::vector<std::vector<int>> eculdianCluster(typename pcl::PointCloud<PointT>::Ptr cloud,typename KdTree_eculdian<PointT>::KdTree_eculdian* tree,float distanceTol,int minSize,int maxSize);
   
    Box BoundingBox(typename pcl::PointCloud<PointT>::Ptr cluster);

    void savePcd(typename pcl::PointCloud<PointT>::Ptr cloud, std::string file);
  
   void Proximity (typename pcl::PointCloud<PointT>::Ptr cloud,std::vector<int> &cluster,std::vector<bool> &processed_f,
